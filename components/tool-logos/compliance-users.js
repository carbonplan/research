...
`}
      ...
      <text transform='matrix(1 0 0 1 24.4376 66.8355)'>
        <tspan x='0' y='0' class='st0-cu st1-cu st2-cu'>
          USER
        </tspan>
        <tspan x='0' y='13.2' class='st3-cu st1-cu st2-cu'>
          ____
        </tspan>
      </text>
      ...
      <g>
        <line class='st5-cu' x1='25.9' y1='41' x2='32.6' y2='34.3' />
        <circle class='st5-cu' cx='37.2' cy='29.6' r='6.2' />
      </g>
    </svg>
  )
}
