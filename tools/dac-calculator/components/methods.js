...
const Methods = () => {
  return (
    <Box sx={{ mt: [4], mb: [0, 0, 5] }}>
      ...
      <Styled.p>
        This calculator computes the <Link href='https://cdrprimer.org/read/chapter-4#sec-4-3'>
          net removed cost
        </Link> ($/tCO₂eq) of carbon
      ...
      <Styled.p>
        ...
        net emissions and factored into net removed cost using a GWP100 of 32. Additionally, the
