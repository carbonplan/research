const techData = {
  Wind: [
    ...
    // TODO: Noah commented this out...
    {
      name: 'Plant Size [MW]',
      displayName: 'Plant Size',
      description: 'xxx',
      unit: 'MW',
      initValue: 200.0,
      show: false,
  ...
  'Advanced Nuclear': [
    ...
    },
    {
      ...
      displayName: 'Lead Time',
      description:
        'The lead time describes the time between the beginning of construction and commissioning of the advanced nuclear facility.',
      unit: 'Years',
      initValue: 6.0,
      validRange: [1, 10],
      step: 1,
    ...
    },
    {
      ...
      displayName: 'Availability',
      description:
        'The availability is the ratio of operating capacity of a given generating resource by the maximum operating capacity over the course of a single day. For advanced nuclear, this is typically near 100% as NGCC is a dispatchable energy resource.',
      unit: '',
      initValue: 1.0,
      validRange: [0.7, 1],
      step: 0.01,
  ...
  'Geothermal EIA 2020': [
    ...
    },
    {
      ...
      displayName: 'Lead Time',
      description:
        'The lead time describes the time between the beginning of construction and commissioning of the geothermal facility.',
      unit: 'Years',
      initValue: 4.0,
      validRange: [1, 10],
      step: 1,
